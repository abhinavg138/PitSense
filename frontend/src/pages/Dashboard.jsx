...
export default function Dashboard() {
    ...
    const renderSection = () => {
        ...
        return <>
            ...
            {analysis && <div className="support-grid radio-layout"><OverviewCard analysis={analysis}/><RadioCommandCard analysis={analysis}/><RecommendationCard analysis={analysis}/></div>}
