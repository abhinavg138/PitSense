...
export default function RadioCommandCard({ analysis }) {
    ...
    const confidence = Math.round(analysis?.engineer_decision?.confidence ?? analysis?.stress_index?.confidence ?? 91);
    ...
    return (
        <div className="radio-command-card glass-card">
            <div className="radio-command-head">
                <div className="section-head"><span>RADIO COMMAND</span><b>● LIVE</b></div>
            ...
            <div className="radio-command-label"><Sparkles size={13} /> AI INTERPRETATION</div>
            ...
            <div className="radio-command-label">SUGGESTED ENGINEER RESPONSE</div>
